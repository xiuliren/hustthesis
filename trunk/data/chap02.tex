...
\begin{figure}[!htbp]%
\centering
\subfloat[一只猫的幸福]{\label{fig:cat1}\includegraphics[scale=0.9]{cat.eps}}%
\qquad
\subfloat[一只猫的幸福]{\label{fig:cat2}\includegraphics[scale=0.9]{cat.eps}}%
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=10cm]{cat.eps}
\caption{一只猫的幸福}
